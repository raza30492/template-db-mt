...
import com.jazasoft.mt.assember.UrlInterceptorAssembler;
...
public class InterceptorRestController {
    ...
    @Autowired InterceptorService urlInterceptorService;

    @Autowired UrlInterceptorAssembler urlInterceptorAssembler;

...
import {USER_ROLE as ur} from  '../utils/constants';
...
class NavSidebar extends Component {
  ...
  render () {
    const { itemsAdmin, itemsUser } = this.props.nav;

    const items = (sessionStorage.role == ur.ROLE_ADMIN) ? itemsAdmin : itemsUser;

...
import {addUser, syncUser}  from '../../actions/user';
import {USER_ROLE as ur, USER_CONSTANTS as uc}  from '../../utils/constants';
...
class UserAdd extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (nextProps.user.syncUser) {
      this.props.dispatch(syncUser(nextProps.user.lastSync));
    }
  }
  ...
  _onClose () {
    this.props.dispatch({type: uc.USER_ADD_FORM_TOGGLE, payload: {adding: false}});
  }

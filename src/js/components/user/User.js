...
class User extends Component {
  ...
  componentWillMount () {
    ...
    if (!this.props.misc.initialized) {
      ...
      this._loadUser(users,filter,sort);
    }
  }
  ...
  _onSearch (event) {
    ...
    usrs = users.filter(u => u.name.toLowerCase().includes(value.toLowerCase()) || u.email.toLowerCase().includes(value.toLowerCase()));
...
//  }
  ...
  render() {
    ...
    let tableHeaders = ['Name','Username','Email','Mobile','Role','Action'];
